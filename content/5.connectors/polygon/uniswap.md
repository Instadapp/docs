...
UniswapV3-v1 connector triggers methods like createAndInitializePool, mint, deposit, withdraw, collect, burn. You can view details like source code, ABIs on [Polygonscan](https://polygonscan.com/address/0xb5e4b2a67e0643afa793e2defbac7984811cd455#code).
...
spells.add({
  ...
  method: "createAndInitializePool",
  args: [tokenA, tokenB, fee, initialTick]
});
```
...
<table class="table">
  <tr>
   ...
   <tr>
   <tr>
     <td><code>initialTick</code></td>
     <td>int24</td>
     <td>Initial tick for the pool</td>
   <tr>
</table>
