...
---
> DEX Aggregator.
Paraswap-v5 connector triggers methods like swap. You can view details like source code, ABIs on [Etherscan](https://ftmscan.com//address/0x5b7d61b389d12e1f5873d0ccee7e675915ab5f43#code).
...
<table class="table">
  <tr>
   ...
   <tr>
     ...
     <td>address</td>
     <td>The address of the token to buy.(For FTM: 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE)</td>
   <tr>
   <tr>
     <td><code>sellAddr</code></td>
     <td>address</td>
     <td>The address of the token to sell.(For FTM: 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE)</td>
   <tr>
   <tr>
