...
Basic-v1.1 connector triggers methods like deposit, depositFrom, withdraw. You can view details like source code, ABIs on [Etherscan](https://ftmscan.com//address/0x2249afe319baa0137cb434116ac4d4fd5c3eb719#code).
...
<table class="table">
  <tr>
   ...
   <tr>
     <td><code>token</code></td>
     <td>address</td>
     <td>The address of the token to deposit. (Note: FTM is not supported. Use `deposit()`)</td>
   <tr>
   <tr>
     <td><code>amt</code></td>
     <td>uint256</td>
