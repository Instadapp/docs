...
Pangolin-v1 connector triggers methods like deposit, withdraw, buy, sell. You can view details like source code, ABIs on [Snowtrace](https://snowtrace.io/address/0x6798a4fe4420f08de26ff3062492c057c4eb9a74#code).
...
Deposit Liquidity to a Pangolin pool.

```javascript
spells.add({
  connector: "PANGOLIN-A",
  method: "deposit",
...
Withdraw Liquidity from a Pangolin pool.
