...
Basic-v1.1 connector triggers methods like deposit, depositFrom, withdraw. You can view details like source code, ABIs on [Snowtrace](https://snowtrace.io/address/0x34c1de737e201f9581f37564b492b492288eb7af#code).
...
<table class="table">
  <tr>
   ...
   <tr>
     <td><code>amt</code></td>
     <td>uint256</td>
     <td>The amount of tokens to deposit. (For max: `uint256(-1)` (Not valid for AVAX))</td>
   <tr>
   <tr>
...
<table class="table">
  <tr>
   ...
   <tr>
     <td><code>token</code></td>
     <td>address</td>
     <td>The address of the token to deposit. (Note: AVAX is not supported. Use `deposit()`)</td>
   <tr>
   <tr>
     <td><code>amt</code></td>
     <td>uint256</td>
