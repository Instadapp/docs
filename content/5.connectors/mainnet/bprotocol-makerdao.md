---
title: B.Protocol MakerDAO
description: Collateralized Borrowing.
draft: true
---
> Collateralized Borrowing.
B.MakerDAO-v1.0 connector triggers methods like open, close, transfer, deposit, withdraw, borrow, payback, withdrawLiquidated, depositAndBorrow, exitDai, depositDai, withdrawDai. You can view details like source code, ABIs on [Etherscan](https://etherscan.io/address/0xb0a1f10feefecf25064ce7cdf0a65042f7de7bf0#code).
...
<table class="table">
  <tr>
   ...
   <tr>
     ...
     <td>address</td>
     <td>Address of the next owner of the vault.</td>
   <tr>
</table>
